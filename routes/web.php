...
//String crypter = Crypt::encryptString("SUPCONNEXION");
...
Route::prefix('ecole')->group(function(){
    ...
    Route::get('/annonce/create/'{{Crypt::encrypt('SUPCONNEXION')}}, 'Users\Ecole\AnnonceController@creer')->name('annonce.creer');
