														...
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>Titre</label>
																	<input type="text" class="form-control" name="titre" placeholder="Entrez le titre de l'horaire">
																</div>
															</div>
														</div>
													</div>
													...
													<tr>		
														...
														<td>
															<div class="form-button-action">
																<a href="{{ route('horaires.show',$horaire->id)}}" class="btn btn-link btn-primary btn-lg" data-original-title="Editer Horaire">
														...
														<td>
															<div class="form-button-action">
																<form action="{{ route('horaires.destroy', $horaire->id)}}" method="post" style="display: inline-block">
																	@csrf
																	@method('DELETE')
