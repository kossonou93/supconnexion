		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
                    ...
                    <h4 class="page-title">Editer un Contrat</h4>
					<div class="row">
						<div class="col-md-8">
									...
									<div class="row mt-3">
										<div class="col-md-12">
											<div class="form-group form-group-default">
												<label>Ville</label>
												<input type="text" class="form-control" name="name" value='{{ $ville->name }}' placeholder="Entrez le type de la contrat" required>
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group form-group-default">
