		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
                    ...
                    <h4 class="page-title">Editer une discipline</h4>
					<div class="row">
						<div class="col-md-8">
									...
									<div class="row mt-3">
										<div class="col-md-12">
											<div class="form-group form-group-default">
												<label>Nom</label>
												<input type="text" class="form-control" name="name" value="{{ $discipline->name }}" placeholder="Entrez le nom de la discipline">
											</div>
										</div>
                                    </div>
