		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
                    ...
                    <h4 class="page-title">Editer une formation</h4>
					<div class="row">
						<div class="col-md-8">
									...
									<div class="row mt-3">
										<div class="col-md-12">
											<div class="form-group form-group-default">
												<label>Type</label>
												<input type="text" class="form-control" name="type" value="{{ $formation->type }}" placeholder="Entrez le type de la formation" required>
											</div>
										</div>
                                    </div>
