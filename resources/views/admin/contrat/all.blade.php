														...
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>Type</label>
																	<input type="text" class="form-control" name="type" placeholder="Entrez le type de contrat">
																</div>
															</div>
														</div>
													</div>
													...
													<tr>		
														...
														<td>
															<div class="form-button-action">
																<a href="{{ route('contrats.show',$contrat->id)}}" class="btn btn-link btn-primary btn-lg" data-original-title="Editer Contrat">
