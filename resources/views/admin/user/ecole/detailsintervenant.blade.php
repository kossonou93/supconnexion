                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="col-md-6">
                                                                <div class="form-group form-group-default">
                                                                    <label>Nom</label>
                                                                    <br>
                                                                    <h3 style='font-family: "Comic Sans MS", Times, serif;'>{{ $intervenant->name }}</h3>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group form-group-default">
                                                                    <label>Prénom</label>
                                                                    <br>
                                                                    <h3 style='font-family: "Comic Sans MS", Times, serif;'>{{ $intervenant->last_name }}</h3>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row mt-3">
                                                            <div class="col-md-6">
                                                                <div class="form-group form-group-default">
                                                                    <label>Email</label>
                                                                    <br>
                                                                    <h3 style='font-family: "Comic Sans MS", Times, serif;'>{{ $intervenant->email }}</h3>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <br>
                                                                    <h3 style='font-family: "Comic Sans MS", Times, serif;'>{{ $intervenant->phone }} / {{ $intervenant->contact }}</h3>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row mt-3">
                                                            <div class="col-md-6">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <br>
                                                                    <h3 style='font-family: "Comic Sans MS", Times, serif;'>{{ $intervenant->fonction }}</h3>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    @foreach ( $villes as $ville )
                                                                        <h3 style='font-family: "Comic Sans MS", Times, serif;'>
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="col-md-6">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <br>
                                                                    <h3 style='font-family: "Comic Sans MS", Times, serif;'>{{ $intervenant->birth_day }}</h3>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group form-group-default">
                                                                    <label>Sexe</label>
                                                                    <br>
                                                                    <h3 style='font-family: "Comic Sans MS", Times, serif;'>{{ $intervenant->sexe }}</h3>
                                                                </div>
                                                            </div>
													    </div>
                                                        <div class="row mt-3 mb-1">
                                                            <div class="col-md-12">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <br>
                                                                    <h2 style='font-family: "Comic Sans MS", Times, serif;'>{{ $intervenant->motivation }}</h2>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <br><br>
                                                                ...
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <ul class="list-group">
                                                                        @foreach ( $conts as $cont )
																			<h3 style='font-family: "Comic Sans MS", Times, serif;'><li class="list-group-item">{{ $cont->type }}</li></h3>
																		@endforeach
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <ul class="list-group">
                                                                        @foreach ( $inters as $inter )
																			<h3 style='font-family: "Comic Sans MS", Times, serif;'><li class="list-group-item">{{ $inter->type }}</li></h3>
																		@endforeach
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <ul class="list-group">
                                                                        @foreach ( $dispos as $dispo )
																			<h3 style='font-family: "Comic Sans MS", Times, serif;'><li class="list-group-item">{{ $dispo->titre }}</li></h3>
																		@endforeach
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="col-md-12">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <ul class="list-group">
                                                                        @foreach ( $durs as $dur )
																			<h3 style='font-family: "Comic Sans MS", Times, serif;'><li class="list-group-item">{{ $dur->type }}</li></h3>
																		@endforeach
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <ul class="list-group">
                                                                        @foreach ( $texps as $texp )
																			<h3 style='font-family: "Comic Sans MS", Times, serif;'><li class="list-group-item">{{ $texp->type }}</li></h3>
																		@endforeach
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <ul class="list-group">
                                                                        @foreach ( $langs as $lang )
																			<h3 style='font-family: "Comic Sans MS", Times, serif;'><li class="list-group-item">{{ $lang->name }}</li></h3>
																		@endforeach
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="col-md-12">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <ul class="list-group">
                                                                        @foreach ( $hors as $hor )
																			<h3 style='font-family: "Comic Sans MS", Times, serif;'><li class="list-group-item">{{ $hor->titre }}</li></h3>
																		@endforeach
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <ul class="list-group">
                                                                        @foreach ( $remus as $remu )
																			<h3 style='font-family: "Comic Sans MS", Times, serif;'><li class="list-group-item">{{ $remu->type }}</li></h3>
																		@endforeach
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <ul class="list-group">
                                                                         @foreach ( $discips as $discip )
																			<h3 style='font-family: "Comic Sans MS", Times, serif;'><li class="list-group-item">{{ $discip->name }}</li></h3>
																		@endforeach
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="col-md-12">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <br>
                                                                    <ul class="list-group">
																		<h3 style='font-family: "Comic Sans MS", Times, serif;'><li class="list-group-item">{{ $intervenant->competence }}</li></h3>
                                                                    </ul>
                                                                </div>
                                                            </div>
													    </div>
                                                                ...
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <ul class="list-group">
                                                                        @foreach ( $formas as $forma ) 
																		    <h3 style='font-family: "Comic Sans MS", Times, serif;'><li class="list-group-item">{{ $forma->type }}</li></h3>
                                                                        @endforeach
                                                                    </ul>
                                                                </div>
                                                            </div>
