												...
												<div class="row mt-3">
													<div class="col-md-8">
														<div class="form-group form-group-default">
															...
															<input type="text" class="form-control" name="intitule" value="{{ $annonce->intitule }}" required>
														</div>
													</div>
												</div>
												<div class="row mt-3">
													<div class="col-md-8">
														<div class="form-group form-group-default">
															...
															<textarea class="form-control" name="description" placeholder="" rows="3" value="{{ $annonce->description }}" required>{{ $annonce->description }}</textarea>
														</div>
													</div>
												</div>
												<div class="row mt-3">
													<div class="col-md-8">
														<div class="form-group form-group-default">
															...
															<input type="date" class="form-control" name="date_limite" value="{{ $annonce->date_limite }}" required>
														</div>
													</div>
												</div>
												<div class="row mt-3">
