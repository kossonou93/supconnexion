                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="renovation">
                                ...
                                <div class="renovation_content">
                                    ...
                                    <p class="mb-0" style="margin-top: 5px; text-align:center"><a href="{{ route('annonce.details',$annonce->id)}}" class="btn btn-primary">@lang('public.enSavoirPlus')<span class="ion-ios-arrow-round-forward"></span></a></p>
                                </div>
                            </div>
                        </div>
                    @endforeach
