...
return [
    ...
    'prixService' => "Prices for our Services are listed below and may occasionally change without notice. These prices are exclusive of VAT. Payment for our Services will be made in Euros within thirty (30) days of the invoice date. In the event of non-payment within thirty (30) days following the date of the invoice, access to our Services will be refused. All sales are firm and non-refundable. <br><br>The price of an advertisement presented in the price list is the price for a specific information given. In the case of publishing a lot of information in an advertisement, the total price of this advertisement will be specified and based on the number of information to be passed on.",
    'produit' => "Product",
    'prix' => "Net price in €",
