...
return [
    ...
    'ville' => "City",
    'phone' => "Phone",
    'aproposEcole' => "About the School",
    'renseignezModif' => "Fill in or Modify the information of your establishment",
    'filiereFormation' => "Sectors or Training",
    'langueEns' => "Possible teaching languages",
    'plageHoraire' => "Desired time slots",
    'telechargerProfil' => "Download My Profile",
    'selectionTypeEcole' => "Select the types of establishments that correspond to yours",
    'profilEcole' => "Institution profile",
    'recherche' => "Research",
    'profil' => "Profile",
    'mesAnnonce' => "My ads",
    ...
    'connexion' => "You are connected!",
    'passwordIncorrect' => "Email ou Mot de Passe incorrect!",
    'diplome' => "Diplomas",
    'experience' => "Experiences",
    'renseignModif' => "Fill in or Modify your information",
    'dateNais' => "Date of birth",
    'sexe' => "Sex",
    'male' => "Male",
    'female' => "Female",
    'villeResidence' => "City of residence",
    'lienLinkedin' => "Enter the link to your LinkedIn profile",
    'ajoutCV' => "Add your up-to-date Curriculum Vitae",
    'visiterLinkedin' => "Visit my linkedin profile",
    'telechargeCV' => "Download my resume",
    'photoProfil' => "Profile picture",
    'exEntreprise' => "Title of your current position and your company (e.g. Financial Director at Company X)",
    'parcoursMotivation' => "Brief presentation of your background and motivations",
    'vosCritere' => "YOUR CRITERIA",
    'typeContrat' => "Types of contracts accepted / possible (if remuneration)",
    'interventionDistant' => "Remote interventions and travel",
    'disponibiliteAnnee' => "Availability in the year",
    'dureeIntervention' => "Desired duration of intervention",
    'mesExperiences' => "My experiences in teaching and training",
    'langueEnsei' => "Possible teaching languages",
    'plageHoraire' => "Desired time slots",
    'remuneration' => "Remuneration",
    'domaineInter' => "General area(s) of intervention",
    'domaineComp' => "SPECIFY YOUR AREAS OF SKILLS*",
    'mesOffres' => "My offers",
    'ajoutDiplome' => "Add Diploma",
    'nouveau' => "New",
    'titre' => "Title",
    'ajoutExp' => "Add Experience",
    'new' => "New",
    'intituleInter' => "Title of the intervention",
    'entreprise' => "Establishment or company",
    'dateDebutInter' => "Intervention start date",
    ...
    'nbreParticipant' => "Number of participants in your intervention",
    'supportInter' => "I created the intervention materials",
    'autreExp' => "Other Notable Experiences",
    'non' => "NO",
    'oui' => "YES",
    'editExp' => "Edit Experience",
    'editDip' => "Edit Diploma",
    ...
    'diplomeSupprimer' => "Diploma successfully removed!",
    'diplomeModifier' => "Diploma successfully modified!",
    ...
    'cdtGleVente' => "Click on the link below to download our general conditions of sale",
